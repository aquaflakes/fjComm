...
score_genome_gkmers_cpp <- function(seqnames, seqs, starts, target_kmers, kmer_scores, gapmin = 0L, gapmax = 8L) {
    .Call('_fjComm_score_genome_gkmers_cpp', PACKAGE = 'fjComm', seqnames, seqs, starts, target_kmers, kmer_scores, gapmin, gapmax)
}
